...
<form action="${pageContext.request.contextPath}/PostPropertyController" method="post">
    ...
    <div style="display: flex; gap:170px;margin-top:40px; ">
        ...
        <div class="subColumn">
          ...
          <input type="text" name="title" class="underline-long">
        </div>
          <div class="subColumn">
            <label class="form-label">Price</label>
            <input type="text" name="price" class="underline-short">
          </div> 
      </div>
      <div style="margin-top:40px;">
          <label class="form-label">Property Type</label>
          <div class="button-group">
            <input type="checkbox" id="colony" name="propertyType" value="colony" class="feature-checkbox">
            <label for="colony" class="feature-label">Colony</label>
            
            <input type="checkbox" id="apartment" name="propertyType" value="apartment" class="feature-checkbox">
            <label for="apartment" class="feature-label">Apartment</label>
            
            <input type="checkbox" id="house" name="propertyType" value="house" class="feature-checkbox">
        ...
        <div class="subRowDetails">
          <div class="subColumn">
            ...
            <input type="text" name="address" class="underline-short">
          </div>
          <div class="subColumn">
            <label class="form-label">City</label>
            <input type="text" name="city" class="underline-short">
          </div>
          <div class="subColumn">
            <label class="form-label">Area</label>
            <input type="text" name="area" class="underline-short">
          </div>
        </div>
          ...
          <div class="subRow">
            <div class="subColumn">
              ...
              <div class="button-group">
				...
				<input type="checkbox" id="parking" name="amenity_parking" value="parking" class="feature-checkbox" checked>
				...
				<input type="checkbox" id="lift" name="amenity_lift" value="lift" class="feature-checkbox" checked>
				...
				<input type="checkbox" id="gym" name="amenity_gym" value="gym" class="feature-checkbox" checked>
				...
				<input type="checkbox" id="fencing" name="amenity_fencing" value="fencing" class="feature-checkbox" checked>
				...
				<input type="checkbox" id="conditioning" name="amenity_conditioning" value="conditioning" class="feature-checkbox" checked>
				<label for="conditioning" class="feature-label">Conditioning</label>
				
				<input type="checkbox" id="fire-alarm" name="amenity_fire_alarm" value="fire-alarm" class="feature-checkbox" checked>
				...
				<input type="checkbox" id="security" name="amenity_security" value="security" class="feature-checkbox" checked>
