      ...
      <div style="margin-top:40px;">
        ...
        <div style=" display: flex; margin-top: 50px; gap: 19.5%;">
          <div class="subColumn">
            ...
            <img src="${pageContext.request.contextPath}/images/uploadImage.png" style="max-width:36.48px;margin-left:28px;padding:20px" > 
          </div>
          <div class="subColumn">
            <label class="form-label">Upload Photos</label>
            <img src="${pageContext.request.contextPath}/images/uploadImage.png" style="max-width:36.48px;margin-left:24px;padding:20px" >
          </div>
        </div>
