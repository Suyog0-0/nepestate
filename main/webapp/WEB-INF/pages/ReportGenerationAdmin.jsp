    ...
    <div style="margin-left: 7%;">
        ...
        <c:if test="${reportGenerated == true}">
            <div class="report-container">
                <h2>Platform-Wide Property Report</h2>
                
                <div class="report-section">
                    <h3>Summary</h3>
                    <p>Total Properties in System: <strong>${reportData.totalProperties}</strong></p>
                    <p>Total Property Value on Platform: <strong><fmt:formatNumber value="${reportData.totalPropertyValue}" type="currency" currencySymbol="Rs."/></strong></p>
                </div>
                    ...
                    <table class="report-table">
                        ...
                        <c:forEach items="${reportData.statusCounts}" var="entry">
                            <tr>
                                <td>${entry.key}</td>
                                <td>${entry.value}</td>
                                <td><fmt:formatNumber value="${entry.value / reportData.totalProperties * 100}" maxFractionDigits="1"/>%</td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
