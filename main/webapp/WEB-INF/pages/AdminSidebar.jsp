    ...
    <div class="sidebar-top">
      ...
      <nav class="nav-menu">
        <a href="${pageContext.request.contextPath}/admindashboard" class="nav-link active">
          <img src="${pageContext.request.contextPath}/images/dashboard.png" class="icon nav-icon" />
          Dashboard
        </a>
        <a href="${pageContext.request.contextPath}/propertylisting" class="nav-link">
          <img src="${pageContext.request.contextPath}/images/properties.png" class="icon nav-icon" />
          Properties
        </a>
        <a href="${pageContext.request.contextPath}/ProductAdmin" class="nav-link">
          <img src="${pageContext.request.contextPath}/images/users.png" class="icon nav-icon" />
          Users
        </a>
        <a href="${pageContext.request.contextPath}/ReportGeneration" class="nav-link">
          <img src="${pageContext.request.contextPath}/images/report.png" class="icon nav-icon" />
          Report
        </a>
      </nav>
    </div>
