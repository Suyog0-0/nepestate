...
public class ImageUtil {
     ...
     * @param rootPath   the absolute filesystem path to your webapp root (e.g.
     *                   obtained via
     *                   <code>getServletContext().getRealPath("")</code>).
     * @param saveFolder the sub‐directory under your webapp's images folder where
     *                   this file should go (e.g. "users" or "properties").
    ...
    public boolean uploadImage(Part part, String rootPath, String saveFolder) {
        // Build the full save path under WEB-INF/images/<saveFolder>
    ...
    /**
     * Constructs the full filesystem path where images should be stored.
     * 
     * @param rootPath   the absolute filesystem path of the webapp root
     * @param saveFolder the directory under /images/ to hold this upload
     * @return the full directory path, e.g.
     *         "/.../webapp/images/users"
     */
    public String getSavePath(String rootPath, String saveFolder) {
        // Assumes your images folder is at webapp/images/
        return rootPath
             + File.separator
             + "images"
             + File.separator
